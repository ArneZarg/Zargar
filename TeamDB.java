//Charlson So, Arne Zargarian, Christine Martin
//CSIS 130
//Lab 11
...
public class TeamDB
{
   public static void main(String[] args)
   {
      ...
      final String URL = "jdbc:derby:TeamDB;" +
                            "create=true";
   ...
   public static void addTeams(Connection conn)
   {
      ...
      try
      {
         ...
         do
         {
            ...
            System.out.println("If sucessful then 1: "+ Integer.toString(result));
   ...
   public static void enterScores(Connection conn)
   {
      ...
      try
      {
         ...
         do
         {
            ...
            result = stmt.executeQuery("SELECT * From Games WHERE GameNumber="+Integer.toString(gameNumber)); 
            ...
            if(result.next())
            {
               ...
               String state = "UPDATE Games" + " SET "+ "HomeTeamScore= "+Integer.toString(score1)+
               " WHERE GameNumber" + "="+Integer.toString(gameNumber);
               
               int row = stmt.executeUpdate(state);
               
               state = "UPDATE Games" + " SET "+ "VisitorTeamScore= "+Integer.toString(score2)+
               " WHERE GameNumber" + "="+Integer.toString(gameNumber);
               row = stmt.executeUpdate(state);
               ...
               if(score1 < score2)
               {
                  ...
                  //first team name select
                //  state = "SELECT TeamName, Losses From Teams WHERE TeamName = '"+homeTeam+"'";
                  
                  state = "SELECT * From Teams WHERE TeamName = '"+homeTeam+"'";
                  result = stmt.executeQuery(state);
     
                  result.next();
                  int j = result.getInt("Losses");
                  j++;

                  state = "UPDATE Teams SET Losses = "+Integer.toString(j)+"WHERE TeamName = '"+homeTeam+"'";
                  
                  int k = stmt.executeUpdate(state);
                  
                  //second team select
                  
                  state = "SELECT * From Teams WHERE TeamName = '"+visitingTeam+"'";
                  result = stmt.executeQuery(state);
     
                  result.next();
                  j = result.getInt("Wins");
                  j++;

                  state = "UPDATE Teams SET Wins = "+Integer.toString(j)+"WHERE TeamName = '"+visitingTeam+"'";
                  
                  k = stmt.executeUpdate(state);
               ...
               else if(score2 < score1)
               {
                  ...
                  state = "UPDATE Teams SET Losses = "+Integer.toString(j)+"WHERE TeamName = '"+visitingTeam+"'";
                  ...
                  state = "UPDATE Teams SET Wins = "+Integer.toString(j)+"WHERE TeamName = '"+homeTeam+"'";
               ...
               else
               {
                ...
                state = "SELECT * From Teams WHERE TeamName = '"+visitingTeam+"'";
                  ...
                  result.next();
                  int j = result.getInt("Ties");
                  j++;

                  state = "UPDATE Teams SET Ties = "+Integer.toString(j)+"WHERE TeamName = '"+visitingTeam+"'";
                  ...
                  result.next();
                  j = result.getInt("Ties");
                  j++;

                  state = "UPDATE Teams SET Ties = "+Integer.toString(j)+"WHERE TeamName = '"+homeTeam+"'";
